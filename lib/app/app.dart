...
import 'package:memoir/screens/settings/developer.dart';
      ...
      builder: (_, __) {
        return MaterialApp(
          ...
          routes: {
            ...
            Routes.vault: (_) {
              return const SecureAppSwitcherPage(child: VaultPage());
            },
